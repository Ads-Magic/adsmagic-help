...
sidebar\_label: Introduction slug: /
...
\<a class="card padding--lg cardContainer\_node" href="/docs/getting-started/installation" style="height: 100%; border: 1px solid var(--ifm-color-emphasis-200);"\>  
...
\</div\>  
\<div class="col col--6 margin-bottom--lg"\>  
\<a class="card padding--lg cardContainer\_node" href="/docs/tracking-fixing/setup-capi" style="height: 100%; border: 1px solid var(--ifm-color-emphasis-200);"\>  
...
\</div\>  
\<div class="col col--6 margin-bottom--lg"\>  
\<a class="card padding--lg cardContainer\_node" href="/docs/profit-strategy/poas-101" style="height: 100%; border: 1px solid var(--ifm-color-emphasis-200);"\>  
...
\</div\>  
\<div class="col col--6 margin-bottom--lg"\>  
\<a class="card padding--lg cardContainer\_node" href="/docs/agency/white-label" style="height: 100%; border: 1px solid var(--ifm-color-emphasis-200);"\>  
...
To get the most out of Ads Magic, it helps to understand our vocabulary.

| Concept | Definition |
| :---- | :---- |
| **Hybrid Architecture** | We use your server for bulk XML generation (The Cargo Train) and our Cloud for instant API updates (The Speed Boat). This keeps your site fast. |
| **POAS** | **Profit on Ad Spend.** The metric that matters. Calculated as (Revenue \- COGS \- Spend) / Spend. |
| **CAPI** | **Conversions API.** A direct server-to-server connection that sends purchase data to Meta/Google, bypassing browser ad blockers. |
| **Health Check** | An automated audit that scans your products for critical errors (Missing GTIN, Price Mismatch) before they hit Google. |
